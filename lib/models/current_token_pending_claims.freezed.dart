...
class _$_CurrentTokenPending implements _CurrentTokenPending {
  ...
  @override
  String toString() {
    return 'CurrentTokenPending(fromAddress: $fromAddress, creatorAddress: $creatorAddress, collectionName: $collectionName, name: $name, propertyVersion: $propertyVersion)';
  }
...
abstract class _CurrentTokenPending implements CurrentTokenPending {
  const factory _CurrentTokenPending(
      ...
      required final int propertyVersion}) = _$_CurrentTokenPending;
